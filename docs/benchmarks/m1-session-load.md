...
**Date:** 2026-05-23T03:41:16.5676570Z
**Runtime:** .NET 10.0.8
...
|-----------|-------------|-------------|--------|
| P50 | 109 µs | < 1 ms | — |
| P95 | 225 µs | 1 ms | ≤ 20 ms ✅ |
| P99 | 305 µs | < 1 ms | — |

## Verdict

- **R5-A INSERT GATE:** P95 = 14 µs (1 ms) ≤ 50 ms ✅ PASS
- **R5-A QUERY GATE:**  P95 = 225 µs (1 ms) ≤ 20 ms ✅ PASS
